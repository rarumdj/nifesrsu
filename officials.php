...
<main role="main">
      ...
      <article>
        <header class="section background-primary text-center">
          <h1 class="text-white margin-bottom-0 text-size-50 text-thin text-line-height-1">OFFICIALS</h1>
        </header>
        <div class="section background-white"> 
          <div class="line">
            <div class="margin">
            <h3 style="font-size:32px; text-align:center">Executives</h3>
             <?php 

                $select_gen = "SELECT * FROM generations";
...
<button class="accordion"><?php echo $gen_name."  ".$gen_year; ?></button>
<div class="panel">
<br>
                <div class="line">
                  <div class="margin">
                ...
                $exco_num = mysql_num_rows($result_exco);
                if ($exco_num > 0){
                ...
                <div class="image-with-hover-overlay image-hover-zoom margin-bottom">
                  <div class="image-hover-overlay background-primary"> 
                    <div class="image-hover-overlay-content text-center padding-2x">
                      <b><p>Office: <?php echo $office; ?></p></b> 
