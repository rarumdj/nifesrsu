    ...
    <main role="main">
      ...
      <article>
        <header class="section background-primary text-center">
            <h1 class="text-white margin-bottom-0 text-size-50 text-thin text-line-height-1">DONATE</h1>
        </header>
        <div class="section background-white"> 
          <div class="line">

            <h3 style="font-size:32px; text-align:center">GOD BLESS YOU AS YOU GIVE</h3>
            <p style="text-align: center">
            Then Isaac sowed in that land, and reaped in the same year a hundredfold; and the Lord blessed him. – Genesis 26: 12.</p> &nbsp;
