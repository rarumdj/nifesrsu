 ...
 <main role="main">
      ...
      <article>
        <header class="section background-primary text-center">
          <h1 class="text-white margin-bottom-0 text-size-50 text-thin text-line-height-1">CHRISTAIN WRITERS CLUB</h1>
        </header>
      ...
      <div class="container">
        <div class="agileinfo-news-top-grids">
          ...
          <h3 style="font-size:32px; text-align:center">AUDIO</h3>
            <div class="wthree-news-left">
              <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
                ...
                <div id="myTabContent" class="tab-content">
                  ...
                  <li role="presentation"><a href="#home1" id="home1-tab" role="tab" data-toggle="tab" aria-controls="home1" aria-expanded="true"><i class="icon-arrow_left"></i>Latest</a></li>
                  <li role="presentation" style="float:right"><a href="#w3bsd" role="tab" id="w3bsd-tab" data-toggle="tab" aria-controls="w3bsd">Older<i class="icon-arrow_right"></i></a></li>
                </ul>
          ...
          <div class="col-md-4 wthree-news-right">
            ...
            <div class="news-right-top">
              ...
              <div class="wthree-news-right-top" style="min-height:auto; !important">
                <div class="news-grids-bottom">
                  <!-- date -->
                  <div id="design" class="date">
                    <div id="cycler">
                      <div class="date-text">
                        <a href="cwc.php">Publications</a>
                        <p>Christian Litratures.</p>
                      </div>
                      <div class="date-text">
                        <a href="audio.php">Audio</a>
                        <p>Get Acquainted With God's Word Daily.</p>
                      </div>
                    </div>
                  </div>
                  <!-- //date -->
    ...
    <script type="text/javascript" src="js/template-scripts.js"></script>
        <!-- READ MORE -->
    <script>var $el, $ps, $up, totalHeight;

$(".sidebar-box .text-primary-hover").click(function() {
...
function displayRecords(numRecords, pageNum) {
                                $.ajax({
                                    ...
                                    cache: false,
                                    beforeSend: function() {
                                        $('.home1').html('<img src="loader.gif" alt="" width="24" height="24" style="padding-left: 350px; margin-top:50px;" >');
                                    },
