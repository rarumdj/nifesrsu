...
jQuery(document).ready(function(){
        ...
        $("#map").mapmarker({
         ...
         $("#qfaculty").on('change', function(){
            var qfaculty = $("#qfaculty").val();
            if (qfaculty == 'sciences') {
                ...
                $("#qdepartment").html(html);
            }

            else if (qfaculty == 'law') {
                ...
                $("#qdepartment").html(html1);
            }

            else if (qfaculty == 'environmental_science') {
                ...
                $("#qdepartment").html(html2);
            }

            else if (qfaculty == 'engineering') {
                ...
                $("#qdepartment").html(html3);
            }

            else if (qfaculty == 'agriculture') {
                ...
                $("#qdepartment").html(html4);
            }

            else if (qfaculty == 'education') {
                ...
                $("#qdepartment").html(html5);
            }

            else if (qfaculty == 'management_science') {
