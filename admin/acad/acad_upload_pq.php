    ...
    foreach($_FILES['files']['tmp_name'] as $key => $tmp_name ){
        ...
        if(empty($errors)==true){
            ...
            if(is_dir("$desired_dir/".$without)==false){
                ...
                $img_id = generateUser();
// function human_filesize($file_size, $decimals = 2) {
...
// Move to Database
            ...
            $acad_query = "INSERT INTO questions (img_id, faculty, department, level, sem, file_name, file_size, file_type, content, type, date_added) VALUES ('$img_id','$_POST[faculty]','$_POST[department]','$_POST[level]','$_POST[sem]','".$without.'_'.time()."','$file_size','$file_type','$content','$type',NOW())";
...
<head>
    ...
    <title>Uploade Past Questions | <?php echo $_SESSION["office"] ?></title>
    <!-- BOOTSTRAP STYLES-->
