...
$mat_id = $_POST['delete'];
$delete = mysql_query("DELETE FROM materials WHERE id = '$mat_id'");

if($delete == true){
    $reset = mysql_query("ALTER TABLE `materials` DROP `id`");
    $reset = mysql_query("ALTER TABLE `materials` AUTO_INCREMENT = 1");
    $reset = mysql_query("ALTER TABLE `materials` ADD `id` int UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY FIRST");
...
$search_material = mysql_query("SELECT * FROM materials");
                                        ...
                                        <div class="table-responsive">
                                            <form method="POST" accept-charset="utf-8" onsubmit="return confirm('Are You Sure You Want to Deletes?');">
                                                ...
                                                $table = "<table class='table table-striped table-bordered table-hover' id='dataTables-example'>
                                                    ...
                                                    $msearchNum = mysql_num_rows($search_material);
                                                    if ($msearchNum > 0) {
                                                    $table .= "<tbody>";
                                                    while ($row = mysql_fetch_assoc($search_material)) {
