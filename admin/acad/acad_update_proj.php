...
$delete = mysql_query("DELETE FROM projects WHERE id = '$proj_id'");

if($delete == true){
    $reset = mysql_query("ALTER TABLE `projects` DROP `id`");
    $reset = mysql_query("ALTER TABLE `projects` AUTO_INCREMENT = 1");
    $reset = mysql_query("ALTER TABLE `projects` ADD `id` int UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY FIRST");
...
$search_project = mysql_query("SELECT * FROM projects");
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Updata Projects | <?php echo $_SESSION["office"] ?></title>
        <!-- BOOTSTRAP STYLES-->
            ...
            <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
                ...
                <div id="page-wrapper" >
                    <div id="page-inner">
                        <div class="row">
                            <div class="col-md-12">
                                <h5>Welcome, <?php echo $_SESSION["office"] ?> </h5>
                                <?php if(isset($msger)){ ?>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <?php
                                               $table = "<table class='table table-striped table-bordered table-hover' id='dataTables-example'>
                                                    ...
                                                    $psearchNum = mysql_num_rows($search_project);
                                                    if ($psearchNum > 0) {
                                                        $table .= "<tbody>";
                                                    while ($row = mysql_fetch_assoc($search_project)) {
