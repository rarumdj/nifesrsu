...
if (isset($_POST['delete'])) {
    ...
    $del = mysql_query("DELETE FROM publication WHERE id = '$delete'");

    if($del == true){
    $reset = mysql_query("ALTER TABLE `publication` DROP `id`");
    $reset = mysql_query("ALTER TABLE `publication` AUTO_INCREMENT = 1");
    $reset = mysql_query("ALTER TABLE `publication` ADD `id` int UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY FIRST");
...
$select_pub = mysql_query("SELECT * FROM publication");
...
<head>
    ...
    <title>Update Publication | <?php echo $_SESSION["office"] ?></title>
	<!-- BOOTSTRAP STYLES-->
                  ...
                  <!--   Kitchen Sink -->
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            $num_row = mysql_num_rows($select_pub);
                            if ($num_row > 0) {
                              $table .= "<tbody>";
                            while ( $row = mysql_fetch_assoc($select_pub)) {
                $id = $row['id'];
                $title = $row['title'];
                $author = $row['author'];
                $text = $row['text_pub'];
