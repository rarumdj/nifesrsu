...
if (isset($_POST['submit'])) {
  ...
  $query = mysql_query("INSERT INTO publication (title, author, text_pub, file_path, date_added) VALUES ('$title','$author','$text','$path',NOW())");
...
<head>
    ...
    <title>Upload Publication | <?php echo $_SESSION["office"] ?> </title>
	<!-- BOOTSTRAP STYLES-->
