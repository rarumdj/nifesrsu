...
<html lang="en-US">
  <head>
    ...
    <!--  -->
    <link href="o/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
<link href="o/style.css" rel="stylesheet" type="text/css" media="all" />
<link rel="stylesheet" href="o/faqstyle.css" type="text/css" media="all" />
<link href="o/single.css" rel='stylesheet' type='text/css' />
<link rel="stylesheet" href="o/contactstyle.css" type="text/css" media="all" />
<!-- news-css -->
<link rel="stylesheet" href="o/news.css" type="text/css" media="all" />
<!-- //news-css -->
<!-- list-css -->
<link rel="stylesheet" href="o/list.css" type="text/css" media="all" />
    <!-- CUSTOM STYLE -->
 ...
 <main role="main">
      ...
      <div class="container">
        ...
        <?php 
        $wc = mysql_query("SELECT * FROM stayconnected WHERE post_id='$post_id'");
