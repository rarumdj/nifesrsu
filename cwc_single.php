...
<?php
$query1 = mysql_query("SELECT * FROM publication WHERE id = '$post_id'");
...
?>
      ...
      <div class="container">
        ...
        if ($num_row > 0) {
          ...
          $author = $row['author'];
          $description = $row['text_pub'];
          // $date = date("F d, Y",strtotime(['$date_added']));
        ?>
          <div class="col-md-8 wthree-top-news-left">
            <div class="wthree-news-left">
              <div class="wthree-news-left-img">
                <img src="<?php echo "admin/cwc/".$img_path; ?>" alt="" />
                <h4><?php echo $title; ?></h4>
                <div class="w3-agile-news-text">
                  <p style="text-align:justify"><?php echo $description; ?>
                  </p>
                </div>
                <div class="s-author">
               
                  <p><b>Author: <a href="#"><i class="icon-user" aria-hidden="true"></i> <?php echo $author; ?></a></b> &nbsp;&nbsp; <i class="icon-sli-calendar" aria-hidden="true"></i> <?php echo $date; ?> &nbsp;&nbsp;
                  <?php
                  ...
                  <a class="btn btn-default btn-xs"  onclick="likes('<?php echo $post_id; ?>')"><i class="icon-sli-like" aria-hidden="true"></i>Likes(<?php echo $likes; ?>)</a>&nbsp;&nbsp;<a class="btn btn-default btn-xs" onclick="dislikes('<?php echo $post_id; ?>')"><i class="icon-sli-dislike" aria-hidden="true"></i>Dislikes(<?php echo $dislikes; ?>)</a>
                    ...
                    <?php } ?>
                  &nbsp;&nbsp;<a href="admin/cwc/download.php?id=<?php echo $post_id; ?>" ><i class="icon-download" aria-hidden="true"></i>Download</a></p>
                </div>
                <div id="fb-root"></div>
